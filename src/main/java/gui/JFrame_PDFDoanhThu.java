...
public class JFrame_PDFDoanhThu extends javax.swing.JFrame {
    private DefaultTableModel model;
    
    public JFrame_PDFDoanhThu(JTable table, String toString, String text, String text1, String text2) {
