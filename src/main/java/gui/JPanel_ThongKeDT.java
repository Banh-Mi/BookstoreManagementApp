...
public class JPanel_ThongKeDT extends javax.swing.JPanel {
    ...
    private ArrayList<ThongKeDT> doanhThuList = new ArrayList<>();
    ...
    private void loadDuLieuDoanhThu() {
        ...
        for (ThongKeDT doanhThu : doanhThuList) {
