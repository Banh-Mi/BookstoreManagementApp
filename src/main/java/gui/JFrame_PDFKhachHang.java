...
public class JFrame_PDFKhachHang extends javax.swing.JFrame {
    private DefaultTableModel model;
    
    public JFrame_PDFKhachHang(JTable table, String toString, String text, String text1,String text2,String text3) {
