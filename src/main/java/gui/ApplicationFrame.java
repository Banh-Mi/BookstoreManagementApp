...
public final class ApplicationFrame extends javax.swing.JFrame {
    ...
    public void bgMouseExited(roundedPanel panel) {
    ...
    private void initComponents() {
        ...
        miniItem3 = new customLib.roundedPanel();
        svgMinProduct = new customLib.SVGImage();
        miniItem1 = new customLib.roundedPanel();
        svgMinHome = new customLib.SVGImage();
        miniItem2 = new customLib.roundedPanel();
        svgMinSell = new customLib.SVGImage();
        miniItem5 = new customLib.roundedPanel();
        svgMinCustomer = new customLib.SVGImage();
        miniItem6 = new customLib.roundedPanel();
        svgMinDiscount = new customLib.SVGImage();
        miniItem4 = new customLib.roundedPanel();
        svgMinEmployee = new customLib.SVGImage();
        miniItem9 = new customLib.roundedPanel();
        svgMinSupplier = new customLib.SVGImage();
        miniItem7 = new customLib.roundedPanel();
        svgMinStatistical = new customLib.SVGImage();
        miniItem8 = new customLib.roundedPanel();
        svgMinAccount = new customLib.SVGImage();
        miniItem10 = new customLib.roundedPanel();
...
//            chuyenManHinh();
    ...
    private customLib.roundedPanel miniItem1;
    private customLib.roundedPanel miniItem10;
    private customLib.roundedPanel miniItem2;
    private customLib.roundedPanel miniItem3;
    private customLib.roundedPanel miniItem4;
    private customLib.roundedPanel miniItem5;
    private customLib.roundedPanel miniItem6;
    private customLib.roundedPanel miniItem7;
    private customLib.roundedPanel miniItem8;
    private customLib.roundedPanel miniItem9;
