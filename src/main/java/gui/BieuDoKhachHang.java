...
public class BieuDoKhachHang extends javax.swing.JFrame {
    private ThongKeKhachHangDAO khachHangDAO;
    public BieuDoKhachHang() throws SQLException {
        initComponents();
    ...
    public static void main(String args[]) {       
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new BieuDoKhachHang().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(BieuDoKhachHang.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
