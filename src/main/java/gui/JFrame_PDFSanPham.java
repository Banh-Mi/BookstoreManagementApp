...
public class JFrame_PDFSanPham extends javax.swing.JFrame {
    private DefaultTableModel model;
    
    public JFrame_PDFSanPham(JTable table, String toString, String text, String text1, String text4, String text5) {
